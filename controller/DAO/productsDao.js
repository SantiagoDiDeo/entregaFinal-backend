...
class ProductDao {
    ...
    saveProduct = async (productToAdd) => {
        try {
            ...
            logger.error(`${err} --Error al intentar guardar producto: ${productToAdd}`);
        }
    };
    ...
    getProductById = async (id) => {
        try {
            ...
            logger.error(`${err} --Error al intentar encontrar producto con id ${id}`);
        }
    };
    ...
    getProductByCategory = async (category) => {
        try {
            ...
            logger.error(`${err} --Error al intentar encontrar producto con categoria ${category}`);
        }
    };
    ...
    modifyProductById = async (id, item) => {
        try {
            ...
            logger.error(`${err} --Error al intentar modificar producto con id ${id}`);
        }
    };
