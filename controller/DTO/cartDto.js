...
const deleteCartItemDto = async (cartId, itemName) => {
    try {
        ...
        logger.warn(`${error} --Error al eliminar el item del carrito ID: ${cartId}`);
        }
    };

export {createCartDto, getCartByUsernameDto, updateCartDto, deleteCartDto, deleteCartItemDto};
